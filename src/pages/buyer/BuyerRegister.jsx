...
import { buyerRegister } from '../../utils/api';
        ...
        <section className="relative z-10 max-w-7xl mx-auto px-6 py-12 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-10 items-start min-h-[calc(100vh-180px)]">
          <div className="reveal">
            <h1 className="text-3xl md:text-5xl font-extrabold leading-tight">
              Create your account<span className="text-gray-900">.</span>
            </h1>
            <p className="mt-3 md:mt-4 text-gray-600 max-w-xl">
              Register as a buyer to shop authentic delicacies and gifts from Carigara & Barugo with fast delivery.
            </p>
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-700">
              <li className="flex items-center gap-2">
                <span className="text-rose-500">•</span> Secure checkout
              </li>
              <li className="flex items-center gap-2">
                <span className="text-amber-500">•</span> Order tracking
              </li>
              <li className="flex items-center gap-2">
                <span className="text-rose-500">•</span> Local & authentic
              </li>
              <li className="flex items-center gap-2">
                <span className="text-amber-500">•</span> Exclusive promos
              </li>
            </ul>
          </div>
            ...
            <div className="glass rounded-2xl p-6 md:p-8">
              {showSuccess && (
                <div className="mb-4 rounded-lg border border-green-200 bg-green-50 text-green-800 px-4 py-3 text-sm">
                  ✅ Buyer registered successfully! Please verify your email.
                </div>
              )}
              ...
              <h2 className="text-xl font-bold">Register as Buyer</h2>
              <form onSubmit={handleSubmit} className="mt-4 space-y-4">
                ...
                <div className="pt-2">
                  ...
                  <OpenStreetMapAutocomplete
                        ...
                        onChange={(value) => {
                          // Update a combined field if needed
                        }}
                        ...
                        placeholder="Type your full address (e.g., Ilang-ilang Batasan Hills Quezon City)"
                        required
                      />
                ...
                <label className="inline-flex items-center gap-2 select-none text-sm">
                  <input
                    ...
                    name="authorityCheck"
                    type="checkbox"
                    checked={formData.authorityCheck}
                    onChange={handleInputChange}
                    className="rounded"
                    required
                  />
                  <span>I confirm I am authorized to register.</span>
                </label>
