...
import { deliveryRegister } from '../../utils/api';
        ...
        <section className="relative z-10 max-w-7xl mx-auto px-6 py-12 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-10 items-start min-h-[calc(100vh-180px)]">
          <div className="reveal">
            <h1 className="text-3xl md:text-5xl font-extrabold leading-tight">
              Join Our Delivery Network<span className="text-gray-900">.</span>
            </h1>
            <p className="mt-3 md:mt-4 text-gray-600 max-w-xl">
              Become a delivery partner and earn money by delivering authentic Carigara & Barugo products to customers.
            </p>
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-700">
              ...
              <li className="flex items-center gap-2">
                <span className="text-amber-500">•</span> Weekly payouts
              </li>
            </ul>
          </div>
            ...
            <div className="glass rounded-2xl p-6 md:p-8">
              {showSuccess && (
                <div className="mb-4 rounded-lg border border-green-200 bg-green-50 text-green-800 px-4 py-3 text-sm">
                  ✅ Delivery partner registration successful! Please verify your email.
                </div>
              )}
              ...
              <h2 className="text-xl font-bold">Register as Delivery Partner</h2>
              <form onSubmit={handleSubmit} className="mt-4 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className={`input mt-1 w-full rounded-lg border ${
                      fieldErrors.fullName ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300'
                    } bg-white px-3 py-2`}
                    required
                  />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="vehicleType" className="block text-sm font-semibold">Vehicle Type</label>
                    <select
                      id="vehicleType"
                      name="vehicleType"
                      ...
                      onChange={handleInputChange}
                      className={`input mt-1 w-full rounded-lg border ${
                        fieldErrors.vehicleType ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300'
                      } bg-white px-3 py-2`}
                      required
                    >
                  ...
                  <div>
                    <label htmlFor="licenseNumber" className="block text-sm font-semibold">License Number</label>
                    <input
                      id="licenseNumber"
                      name="licenseNumber"
                      type="text"
                      ...
                      onChange={handleInputChange}
                      className={`input mt-1 w-full rounded-lg border ${
                        fieldErrors.licenseNumber ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300'
                      } bg-white px-3 py-2`}
                      required
                    />
                ...
                <div className="pt-2">
                  <h3 className="text-sm font-bold text-gray-800 mb-2">Service Area</h3>
                  ...
                  <OpenStreetMapAutocomplete
                        ...
                        placeholder="Type your service area (e.g., Tacloban Leyte)"
                        required
                      />

                      {selectedAddressData && (
                        <div className="mt-3 bg-green-50 border border-green-200 rounded-lg p-3">
                          <p className="text-xs text-green-700 font-medium mb-2">✅ Service Area Details</p>
