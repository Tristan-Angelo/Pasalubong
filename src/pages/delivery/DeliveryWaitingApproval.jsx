...
import { getDeliveryApprovalStatus } from '../../utils/api';

const DeliveryWaitingApproval = () => {
  ...
  const checkApprovalStatus = async () => {
    try {
      const response = await getDeliveryApprovalStatus();
          ...
          <div className="glass rounded-3xl p-8 md:p-12 text-center">
            ...
            {approvalStatus === 'declined' && (
              <div className="flex justify-center">
                <button
                  onClick={() => navigate('/delivery/upload-valid-id')}
...
export default DeliveryWaitingApproval;